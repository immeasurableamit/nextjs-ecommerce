...
export default function LeftSideBar() {
    return (
        <div className="pp-menu navbar-menu">
            {/* <!-- LOGO --> */}
            ...
            <div id="scrollbar">
                <div className="container-fluid">
                    ...
                    <ul className="navbar-nav" id="navbar-nav">
                        ...
                        <li className="nav-item">
                            <a className="nav-link menu-link" target="_blank" href="landing.html">
                                <i className="ri-rocket-line"></i> <span data-key="t-landing">Landing</span>
                                <span className="badge badge-pill bg-danger" data-key="t-new">New</span>
                            </a>
                        </li>
